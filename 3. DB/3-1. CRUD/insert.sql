...
insert into CATEGORY values('B0000002', '컴퓨터 통신', SYSDATE);
insert into CATEGORY values('B0000003', '게임', SYSDATE);
insert into CATEGORY values('B0000004', '엔터테인먼트, 예술', SYSDATE);
insert into CATEGORY values('B0000005', '생활', SYSDATE);
insert into CATEGORY values('B0000006', '건강', SYSDATE);
insert into CATEGORY values('B0000007', '사회, 정치', SYSDATE);
insert into CATEGORY values('B0000008', '경제', SYSDATE);
insert into CATEGORY values('B0000009', '여행', SYSDATE);
insert into CATEGORY values('B0000010', '스포츠, 레저', SYSDATE);
insert into CATEGORY values('B0000011', '쇼핑', SYSDATE);
insert into CATEGORY values('B0000012', '지역', SYSDATE);
insert into CATEGORY values('B0000013', '결혼', SYSDATE);

-- 관심카테고리
insert into ATT_CATEGORY values('A0000001', 'aaa@google.com', 'B0000001', 'B0000002', 'B0000003', 'B0000004', 'B0000005', '미혼', '무', '무', '유');
insert into ATT_CATEGORY values('A0000002', 'bbb@google.com', 'B0000006', 'B0000007', 'B0000008', 'B0000009', 'B0000010', '기혼', '유', '유', '유');
insert into ATT_CATEGORY values('A0000003', 'ccc@google.com', 'B0000011', 'B0000012', 'B0000013', 'B0000001', 'B0000002', '미혼', '무', '유', '유');
insert into ATT_CATEGORY values('A0000004', 'ddd@google.com', 'B0000003', 'B0000004', 'B0000005', 'B0000006', 'B0000007', '미혼', '무', '무', '무');
insert into ATT_CATEGORY values('A0000005', 'eee@google.com', 'B0000008', 'B0000009', 'B0000010', 'B0000011', 'B0000012', '기혼', '유', '유', '유');
insert into ATT_CATEGORY values('A0000006', 'fff@google.com', 'B0000013', 'B0000001', 'B0000002', 'B0000003', 'B0000004', '기혼', '유', '유', '무');
insert into ATT_CATEGORY values('A0000007', 'ggg@google.com', 'B0000005', 'B0000006', 'B0000007', 'B0000008', 'B0000009', '기혼', '유', '무', '유');
insert into ATT_CATEGORY values('A0000008', 'hhh@google.com', 'B0000010', 'B0000011', 'B0000012', 'B0000013', 'B0000001', '미혼', '무', '무', '유');
insert into ATT_CATEGORY values('A0000009', 'iii@google.com', 'B0000002', 'B0000003', 'B0000004', 'B0000005', 'B0000006', '미혼', '무', '유', '유');
insert into ATT_CATEGORY values('A0000010', 'jjj@google.com', 'B0000007', 'B0000008', 'B0000009', 'B0000010', 'B0000011', '기혼', '유', '유', '유');

-- 주제
insert into SUBJECT values('C0000001', 'B0000001', 'aaa@google.com', '최운학', '주제1', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000002', 'B0000002', 'bbb@google.com', '곽지훈', '주제2', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000003', 'B0000003', 'ccc@google.com', '변정우', '주제3', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000004', 'B0000004', 'ddd@google.com', '이재하', '주제4', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000005', 'B0000005', 'eee@google.com', '조성식', '주제5', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000006', 'B0000006', 'fff@google.com', '박동진', '주제6', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000007', 'B0000007', 'ggg@google.com', '손현준', '주제7', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000008', 'B0000008', 'hhh@google.com', '박상우', '주제8', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000009', 'B0000009', 'iii@google.com', '최정인', '주제9', SYSDATE, SYSDATE, SYSDATE);
insert into SUBJECT values('C0000010', 'B0000010', 'jjj@google.com', '최영훈', '주제10', SYSDATE, SYSDATE, SYSDATE);
...
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'bbb@google.com', '곽지훈', '자게제목2', '자게내용2', null, 0, 0, 0, 'B1CDEF', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'ccc@google.com', '변정우', '자게제목3', '자게내용3', null, 0, 0, 0, 'C2DEFG', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'ddd@google.com', '이재하', '자게제목4', '자게내용4', null, 0, 0, 0, 'D3EFGH', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'eee@google.com', '조성식', '자게제목5', '자게내용5', null, 0, 0, 0, 'E4FGHI', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'fff@google.com', '박동진', '자게제목6', '자게내용6', null, 0, 0, 0, 'F5GHIJ', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'ggg@google.com', '손현준', '자게제목7', '자게내용7', null, 0, 0, 0, 'G6HIJK', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'hhh@google.com', '박상우', '자게제목8', '자게내용8', null, 0, 0, 0, 'H7IJKL', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'iii@google.com', '최정인', '자게제목9', '자게내용9', null, 0, 0, 0, 'I8JKLM', 0, SYSDATE);
insert into BOARD values(BOARD_SEQ.NEXTVAL, 'jjj@google.com', '최영훈', '자게제목10', '자게내용10', null, 0, 0, 0, 'J9KLMN', 0, SYSDATE);

-- 댓글
insert into REPLY values(REPLY_SEQ.NEXTVAL, 2, 'aaa@google.com', '최운학', '댓글내용1', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 3, 'bbb@google.com', '곽지훈', '댓글내용2', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 4, 'ccc@google.com', '변정우', '댓글내용3', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 5, 'ddd@google.com', '이재하', '댓글내용4', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 6, 'eee@google.com', '조성식', '댓글내용5', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 7, 'fff@google.com', '박동진', '댓글내용6', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 8, 'ggg@google.com', '손현준', '댓글내용7', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 9, 'hhh@google.com', '박상우', '댓글내용8', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 10, 'iii@google.com', '최정인', '댓글내용9', null, 0, 0, SYSDATE);
insert into REPLY values(REPLY_SEQ.NEXTVAL, 11, 'jjj@google.com', '최영훈', '댓글내용10', null, 0, 0, SYSDATE);
