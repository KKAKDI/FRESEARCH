...
<body id="top">
	...
	<footer id="footer">
		<div class="inner">
			...
			<ul class="icons">		
				<li><a href="" class="icon fa-envelope"><span class="label">이용약관</span></a></li>
				<li><a href="" class="icon fa-envelope"><span class="label">개인정보 취급방침</span></a></li>			
				<li><a href="#" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
				<li><a href="#" class="icon fa-envelope"><span class="label">Email</span></a></li>
			</ul>
			<p class="copyright">
				Copyright © <a href="https://github.com/KKAKDI/FRESEARCH.git">Team.FRESEARCH</a>
				All rights reserved.
			</p>
		</div>
	</footer>
