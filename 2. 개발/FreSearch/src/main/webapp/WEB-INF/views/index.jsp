   ...
   <div class="notice_back clearfix">
      <div class="notice_area">
         <div class="notice">
            <ul class="notice_rolling">
               <li>
                  <a href="/news/news_get?news_code=8">공지사항 <span>2019년 8월 31일 이용약관 일부 개정 안내</span>
                     <span class="notice_date">2019.08.26</span>
                  </a>
               </li>
               <li>
                  <a href="/news/news_get?news_code=5">공지사항 <span>신고 기능이 잠시 중지됩니다.</span>
                     <span class="notice_date">2019.08.20</span>
                  </a>
               </li>
               <li>
                  <a href="/news/news_get?news_code=6">공지사항 <span>8월 24일(토) 오전 2시~6시, FreSearch 서버 점검 안내</span>
                     <span class="notice_date">2019.08.21</span>
                  </a>
               </li>
               <li>
                  <a href="/news/news_get?news_code=1">공지사항 <span>"FreSerach" 가 서비스를 시작 되었습니다.</span>
                     <span class="notice_date">2019.08.12</span>
                  </a>
               </li>
            </ul>
         </div>
         <div class="event">
            <ul class="event_rolling">
               <li>
                  <a href="/news/news_get?news_code=16">이벤트 <span>통계 예측 이벤트 '2045년 우리는?</span>
                     <span class="event_date">2019.08.14</span>
                  </a>
               </li>
               <li>
                  <a href="/news/news_get?news_code=12">이벤트 <span>[FreSearch] FreSearch 1주일 기념 설문조사 이벤트!</span>
                     <span class="event_date">2019.08.12</span>
                  </a>
               </li>
               <li>
                  <a href="/news/news_get?news_code=14">이벤트 <span>매주 진행되는 리서치 이벤트!!</span>
                     <span class="event_date">2019.08.14</span>
                  </a>
               </li>
               <li>
                  <a href="/news/news_get?news_code=13">이벤트 <span>서비스 오픈 기념 이벤트!!</span>
      ...
      <div class="qreserch_area">
         <ul>
            ...
            <li>
               <a href="/research/research_content?subj_code=5CS9SHKB">
