...
<meta name="google-signin-client_id"
	content="708907828012-qu34esq94i2i1kp96q28pgs1u2s7tnma.apps.googleusercontent.com">
...
<link rel="icon" type="image/png" sizes="32x32"
	href="/resources/img/logoico.png">
<!-- 파비콘 오류 관련 -->
...
<body>
	...
	<div class="loading">
		<img src='/resources/img/logo1_1.png' />
	</div>
	<div class="container">
		<div class="fixed_box">
			<!-- 상단 고정 박스 시작 -->
			<div class="header clearfix">
				...
				<div class="upper clearfix">
					<!-- upper 배경색 적용을 위한 2차 클래스 cf 사용 -->
					<!-- 상단 로그인 -->
					<div class="login">
						<div class="dropdown">
							<button class="dropbtn">
								<img src="/resources/img/bicon14.png" />
							</button>
							<div class="dropdown-content">
								<sec:authorize access="isAuthenticated()">
									...
									<form class="dropdown-form" role="form" action="/logout"
										method='post'>
										<p>
											<img class="img_iconFirst"
												src="/resources/img/member_icon01.png" />
											<sec:authentication property="principal.member.mb_nick" />
										</p>
										<p>
										...
										<div class="bar"></div>
										<a href="/" id="mypage"> <img class="img_iconSecond"
											src="/resources/img/mypage_icon01.png" /> <span
											class="span_mypage">마이페이지 </span>
										</a> <a href="/" class="logout_a" id="logout"> <img
											class="img_iconSecond" src="/resources/img/logout_icon01.png" />
											<span class="span_logout">로그아웃</span>
										</a>
									</form>
								</sec:authorize>
								<sec:authorize access="isAnonymous()">
									<a href="/member/signin"> <img class="img_iconThird"
										src="/resources/img/login_icon01.png" /> <span
										class="span_login">로그인</span>
									</a>
									<a href="/member/signup"> <img class="img_iconThird"
										src="/resources/img/signup_icon01.png" /> <span
										class="span_signup">회원가입</span>
									</a>
								</sec:authorize>
							</div>
						</div>
						...
						<div class="dropdown-alarm widget-gnb">
							...
							<div class="container" id="badge" style="height: 25px;">
								<a class="entypo-bell" style="display: none;"></a> <img
									src="/resources/img/bicon16_1.png"
									style="width: 18px; margin-left: 3px; margin-top: 3px;">
							</div>
							<div id="alarm_content"></div>
							<!-- 종모양 알림 끝 -->
						</div>
					</div>
				...
				<div class="header_inner">
					<div class="logo">
						<h1 id="logo">
							<a href="/"><img src="/resources/img/logo1.png" alt="logo"></a>
						</h1>
					</div>
					<!-- logo -->
					<nav id="GNB">
						<!-- GNB 시작 -->
						<ul>
							<li><a href="/news/news_list">새소식</a></li>
							<li><a href="/research/research_list">리서치</a></li>
							<li><a href="/board/board_list">게시판</a></li>
							<li><a href="/stats/stats_list">데이터베이스</a></li>
							<li><sec:authentication property="principal" var="pinfo" />
								<sec:authorize access="isAuthenticated()">
									<c:choose>
										<c:when
											test="${pinfo.member.authList[0].auth eq 'ROLE_ADMIN'}">
											<a href="/apply/approval_list">패널승인</a>
										</c:when>
										<c:when
											test="${pinfo.member.authList[0].auth eq 'ROLE_USER' || pinfo.member.authList[0].auth eq 'ROLE_PANEL'}">
